...
|
*/
$config['base_url'] = 'https://dev.korzhevdp.com/doctordv/';
...
|
*/
$config['encryption_key'] = 'RFK*08hdrewTpo864*lll1';
...
$config['sess_save_path'] = '/webapps/developing/doctordv/application/cache';
