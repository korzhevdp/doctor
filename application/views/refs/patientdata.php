<tr class="<?=$is_blocked;?>">
	<td class="patrow" ref="<?=$id;?>" title="Щелчок покажет карточку пациента">
		<h6><?=$fio;?></h6>
		Клиент: <a href="/refs/client_edit/<?=$client_id;?>" target="_blank" title="Щелчок покажет карточку клиента"><?=$cli_fio;?></a>
	</td>
	<td class="patrow" ref="<?=$id;?>" title="Щелчок покажет карточку пациента">
		<?=$pat_address;?><br>
	...
	<td style="vertical-align:middle;text-align:center;width:150px;" class="supprow" ref="<?=((strlen($supp_id)) ? $supp_id : 0);?>"  title="Щелчок покажет карточку поставщика">
		<a href="/refs/supp_edit/<?=$supp_id;?>" target="_blank"><?=$supplier;?></a>
	</td>
	...
	<td style="vertical-align:middle; text-align:center;">
		...
		<a class="btn btn-info btn-mini " href="/refs/pat_edit/<?=$id;?>" title="Редактировать данные пациента"><i class="icon-edit icon-white"></i></a>
	</td>
</tr>