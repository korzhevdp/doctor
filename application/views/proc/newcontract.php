	...
	<form method="post" id="servDataForm" action="<?=base_url();?>contracts/cnt_save" enctype="multipart/form-data" class="form-inline row-fluid">
		...
		<div class="tab-content">
			...
			<div class="tab-pane" id="tab2">
				<h5>Услуги по договору <a href="#" id="addService" class="btn btn-mini btn-warning pull-right" title="Добавить услугу в договор">Добавить услугу</a></h5>
...
<div class="modal-footer">
	<button type="submit" class="btn btn-primary" id="contDataSave" style="margin-top:10px;">Создать контракт</button>
